...
func (s *SystemApiApi) SyncApi(c *gin.Context) {
	...
	if err != nil {
		global.Log.Error("同步失败!", zap.Error(err))
...
func (s *SystemApiApi) IgnoreApi(c *gin.Context) {
	...
	if err != nil {
		global.Log.Error("忽略失败!", zap.Error(err))
...
func (s *SystemApiApi) GetApiList(c *gin.Context) {
	...
	response.OkWithDetailed(systemRes.PageResult{
		List:     list,
		Total:    total,
		Page:     pageInfo.Page,
