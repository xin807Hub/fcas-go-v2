...
func (operationRecordService *OperationRecordService) CreateSysOperationRecord(sysOperationRecord system.SysOperationRecord) (err error) {
	err = global.SystemDB.Create(&sysOperationRecord).Error
	return err
}
...
func (operationRecordService *OperationRecordService) DeleteSysOperationRecordByIds(ids systemReq.IdsReq) (err error) {
	err = global.SystemDB.Delete(&[]system.SysOperationRecord{}, "id in (?)", ids.Ids).Error
	return err
}
...
func (operationRecordService *OperationRecordService) DeleteSysOperationRecord(sysOperationRecord system.SysOperationRecord) (err error) {
	err = global.SystemDB.Delete(&sysOperationRecord).Error
	return err
}
...
func (operationRecordService *OperationRecordService) GetSysOperationRecord(id uint) (sysOperationRecord system.SysOperationRecord, err error) {
	err = global.SystemDB.Where("id = ?", id).First(&sysOperationRecord).Error
	return
}
...
func (operationRecordService *OperationRecordService) GetSysOperationRecordInfoList(info systemReq.SysOperationRecordSearch) (list interface{}, total int64, err error) {
	...
	// 创建db
	db := global.SystemDB.Model(&system.SysOperationRecord{})
