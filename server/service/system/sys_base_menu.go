...
func (baseMenuService *BaseMenuService) DeleteBaseMenu(id int) (err error) {
	err = global.SystemDB.First(&system.SysBaseMenu{}, "parent_id = ?", id).Error
	if err != nil {
...
func (baseMenuService *BaseMenuService) UpdateBaseMenu(menu system.SysBaseMenu) (err error) {
	...
	err = global.SystemDB.Transaction(func(tx *gorm.DB) error {
...
func (baseMenuService *BaseMenuService) GetBaseMenuById(id int) (menu system.SysBaseMenu, err error) {
	err = global.SystemDB.Preload("MenuBtn").Preload("Parameters").Where("id = ?", id).First(&menu).Error
	return
}
